...
<head>
    ...
    <title>POLINEMA: User Dashboard</title>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="polinema.png" alt="logo" width="68px"></a>
            </div>
            <div class="main-menu">
                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                         ...
                                         <br>Sistem ini disusun oleh POLINEMA.
                                         <br><br>
                                         Panduan Pendaftaran:
